...
def test_valid_config_loads_correctly(temp_universities_dir: Path):
...
def test_invalid_config_raises_error(temp_universities_dir: Path):
...
def test_missing_config_skipped(temp_universities_dir: Path):
...
def test_slug_mismatch_raises_error(temp_universities_dir: Path):
...
def test_get_universities_endpoint(temp_universities_dir: Path):
    # Setup valid demo university
    demo_dir = temp_universities_dir / "demo"
    demo_dir.mkdir()
    config_data = {
